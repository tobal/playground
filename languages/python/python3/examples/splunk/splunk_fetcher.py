...
def get_search_query():
    return 'search index=* eventtype=windows_logon_success OR eventtype=windows_logoff | transaction Logon_ID mvraw=true startswith="EventCode=4624" endswith="EventCode=4634"'
